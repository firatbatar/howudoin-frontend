...
export default function GroupChat() {
  ...
  const fetchMessages = useCallback(() => {
    ...
    fetch(`${Config.API_URL}/groups/${params.id}/messages`, requestOptions as RequestInit)
  ...
  function sendMessage() {
    ...
    fetch(`${Config.API_URL}/groups/${params.id}/send-message`, requestOptions as RequestInit)
      .then((response) => response.json())
      .then((result) => {
        if (result.status !== 'SUCCESS') {
          console.error(result.message);
